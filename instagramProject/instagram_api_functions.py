...
def get_user_following():
    return api.user_following(api.authenticated_user_id, api.generate_uuid())


def get_user_follows():
    return api.user_followers(api.authenticated_user_id, api.generate_uuid())


def get_user_feed():
    return api.user_feed(api.authenticated_user_id)
...
def follow_user(user_id):
    return api.friendships_create(user_id)


def get_username_info(user_name):
    user = api.username_info(user_name)
    return user['user']['pk']
