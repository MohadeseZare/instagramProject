...
class LoginTest(APITestCase):
    ...
    def test_login_admin(self):
        user = User.objects.create_user(username='username', password=get_user_model().objects.make_random_password(), is_staff=True)
    ...
    def test_login_instagram_account(self):
        user = User.objects.create_user(username='username', password=get_user_model().objects.make_random_password(),
